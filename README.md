...
### Fifth Step:
Run the following command in the other terminal for the frontend:

```bash
npm start
```

Then, your server will run at `http://localhost:XXXX`. Copy that URL and paste it into your browser to see the website.
...
This section has moved here: [Troubleshooting npm run build](https://facebook.github.io/create-react-app/docs/troubleshooting#npm-run-build-fails-to-minify).
